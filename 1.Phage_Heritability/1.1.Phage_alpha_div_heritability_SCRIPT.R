...
# -------------------------------------------------------------------------- #    
    ...
    # Subset dataset with just necessary variables 
    df_analyse <- df %>%
      select(
        iid,
...
write.table(resF,
            file = file.path("/Users/panayiotislouca/Documents/KCL_files/Phages_metagenome_characterisation/Analysis/Phages_heritability/Alpha_diversity/Shannon/Output_heritibility_phage_shannon_diversity.txt"),
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")

write.table(res_sat, 
            file = file.path("/Users/panayiotislouca/Documents/KCL_files/Phages_metagenome_characterisation/Analysis/Phages_heritability/Alpha_diversity/Shannon/Output_heritibility_phage_shannon_diversity_CORR_SAT.txt"),
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")

write.table(res_mod, 
            file = file.path("/Users/panayiotislouca/Documents/KCL_files/Phages_metagenome_characterisation/Analysis/Phages_heritability/Alpha_diversity/Shannon/Output_heritibility_phage_shannon_diversity_MOD.txt"),
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(resF,
            file = file.path("/Users/panayiotislouca/Documents/KCL_files/Phages_metagenome_characterisation/Analysis/Phages_heritability/Alpha_diversity/Taxonomic_richness/Output_heritibility_phage_taxonomic_richness.txt"),
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")

write.table(res_sat, 
            file = file.path("/Users/panayiotislouca/Documents/KCL_files/Phages_metagenome_characterisation/Analysis/Phages_heritability/Alpha_diversity/Taxonomic_richness/Output_heritibility_phage_taxonomic_richness_CORR_SAT.txt"),
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")

write.table(res_mod, 
            file = file.path("/Users/panayiotislouca/Documents/KCL_files/Phages_metagenome_characterisation/Analysis/Phages_heritability/Alpha_diversity/Taxonomic_richness/Output_heritibility_phage_taxonomic_richness_MOD.txt"),
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")
